...
class Jersey(Base):
    ...
    download_url: Mapped[str] = mapped_column("downloadUrl", String)
    ...
    category_id: Mapped[str] = mapped_column("categoryId", ForeignKey("categories.id"))
    ...
    cart_items: Mapped[List["CartItem"]] = relationship(back_populates="jersey")
